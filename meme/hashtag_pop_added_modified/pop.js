...
moreInputButtons.forEach(button => {
    button.addEventListener('click', () => {
        var newDiv = $('<div class="new_hashtag new_hashtag2"><label for="new_hashtag">#</label><input class="new_hashtag hashtag_value" id="new_hashtag" type="text" class="input_hashtag"></div>');
